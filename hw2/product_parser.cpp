 ...
 */
Product* ProductBookParser::makeProduct() { return new Book(categoryID(), prodName_, price_, qty_, isbn_, author_); }
 ...
 * using the data members in this class and the parent ProductParser class
 */
Product* ProductMovieParser::makeProduct() { return new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_); }
