...
{
    Book temp = new Book(category, name, price, qty, isbn, author);
    Product* ptr = temp;
    return ptr;
...
{
    Clothing temp = new Clothing(category, name, price, qty, size, brand);
    Product* ptr = temp;
    return ptr;
...
{
    Movie temp = new Movie(category, name, price, qty, genre, rating);
    Product* ptr = temp;
    return ptr;
